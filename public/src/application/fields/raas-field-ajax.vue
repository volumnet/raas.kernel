  ...
  <div class="raas-field-ajax" :class="{ 'raas-field-ajax_busy': busy }">
    ...
    <div v-if="pValue && pValue.id" class="raas-field-ajax__entity">
      ...
      >
        <img
          v-if="pValue.img"
          :src="pValue.img"
          class="raas-field-ajax__entity-image"
        />
      ...
      <button
        v-if="!multiple"
        type="button"
        class="btn btn-link raas-field-ajax__delete"
    ...
    <template v-else>
      ...
      <ul class="raas-field-ajax__autocomplete" v-if="autocomplete">
        ...
        >
          <img
            v-if="autocompleteItem.img"
            :src="autocompleteItem.img"
            class="raas-field-ajax__autocomplete-item-image"
          />
