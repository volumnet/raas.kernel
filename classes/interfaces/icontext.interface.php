 ...
 * @property-read string $includeDir путь к файлу SOME
 * @property-read string $resourcesDir директория ресурсов
 * @property-read string $installFile путь к файлу установки
 * @property-read string $uninstallFile путь к файлу деустановки
...
{
    /**
     * Минимальная версия PHP, необходимая для работы
     */         
    const requiredPHPVersion = '5.3';
