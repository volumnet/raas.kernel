<p>
  <?php echo General\GREETING?> <b><?php echo htmlspecialchars(\RAAS\Application::versionName); ?></b>. 
...
<p>
  ...
  <b><?php echo USER_THEME?>:</b> <?php echo $VIEW->availableThemes[$VIEW->theme ? $VIEW->theme : '/']?><br />
